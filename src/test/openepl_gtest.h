#ifndef OPENEPL_ENGINE_OPENEPL_GTEST_H
#define OPENEPL_ENGINE_OPENEPL_GTEST_H
...
namespace testing::internal {
        ...
        inline GTEST_API_ AssertionResult DoubleNearPredFormat(const char* expr1, const char* expr2, const char* abs_error_expr, storm::RationalNumber val1,
            ...
            const auto diff = storm::utility::abs<storm::RationalNumber>(val1 - val2);
            if (diff <= abs_error)
...
#endif //OPENEPL_ENGINE_OPENEPL_GTEST_H
